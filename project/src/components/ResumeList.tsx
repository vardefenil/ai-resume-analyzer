    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="text-sm text-slate-600">
          {resumes.length} resume{resumes.length !== 1 ? "s" : ""} • Sorted by
          score
        </div>
      </div>
            ...
            >
              <div className="flex items-start justify-between">
                <div className="flex items-start space-x-4 flex-1">
                  ...
                  <div
                    className={`px-3 py-1 rounded-full text-sm font-medium border ${rankBadge.color}`}
                  >
                    {rankBadge.icon}
                  </div>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center space-x-6 text-sm text-slate-600 mb-3">
                      ...
                      {/* Removed uploadDate because it doesn't exist */}
